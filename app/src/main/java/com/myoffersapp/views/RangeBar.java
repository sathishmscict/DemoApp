...
public class RangeBar extends View {
    ...
    private static final int DEFAULT_BAR_COLOR = Color.parseColor("#51a3df");

    private static final int DEFAULT_TEXT_COLOR = Color.WHITE;

    private static final int DEFAULT_TICK_COLOR = Color.parseColor("#51a3df");

    // Corresponds to material indigo 500.

    // bOLL NO COLOR
    private static final int DEFAULT_PIN_COLOR = Color.parseColor("#51a3df");
    ...
    // Sadi no color
    private static final int DEFAULT_CONNECTING_LINE_COLOR = Color.parseColor("#51a3df");
