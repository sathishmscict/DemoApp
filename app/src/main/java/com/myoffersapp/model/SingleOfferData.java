...
public class SingleOfferData {
    ...
    public class Datum {
        ...
        @Expose
        private String totalratingscount;
        ...
        public String getTotalratingscount() {
            return totalratingscount;
        }

        public void setTotalratingscount(String totalratingscount) {
        ...
        public void setTotalbookmark(String totalbookmark) {
